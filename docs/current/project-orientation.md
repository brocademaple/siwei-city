...
1. 如果主页出现“已恢复上次城邦”，先决定继续演示上次状态，或点“新开一轮”回到干净起点。
2. 看左侧“当前议题”。
3. 保留默认问题，或自己改一句议题。
4. 点击“进入议会”。
5. 在议会内点击“召开完整议会”。
6. 看四位居民席位出现本轮发言。
7. 点击巡城官和卷轴官，看修缮令、报告和行动计划。
8. 返回城邦，看观点建筑、道路和角色 prompt 图鉴。
9. 刷新页面，确认当前城邦恢复；再点“新开一轮”，确认历史卷轴仍保留。
...
- 当前会话会自动保存到 localStorage，刷新或重新打开同一浏览器会恢复。
- 点击“新开一轮”会清空当前会话，但保留卷轴馆里的历史城邦。
