...
如果主页显示“已恢复上次城邦”，可直接继续；要演示干净开局就点“新开一轮”
输入或保留默认议题
点击“进入议会”
在议会内点击“召开完整议会”
查看四位居民发言、巡城官令和卷轴报告
回到城邦，刷新页面，确认上次城邦会恢复
如需重新开始，点击“新开一轮”，当前轮次清空，历史卷轴仍保留
...
| 保存 | 当前行为 |
| --- | --- |
| 当前会话 | 自动写入浏览器 `localStorage`，刷新或重新打开同一浏览器时恢复上次城邦 |
| 历史城邦 | 点击“封存当前城邦”后进入历史列表；点击“新开一轮”只清当前轮次，不清历史卷轴 |
...
| 用户还能继续修吗？ | 建筑、道路、巡检记录刷新后仍保留在当前城邦里 |
| 用户能重新开始吗？ | 主页可点击“新开一轮”清空当前轮次，同时历史城邦保留 |
...
当前已经能保存、恢复和重开。后续可以补历史城邦重命名、删除、导出，以及跨设备账号同步。
