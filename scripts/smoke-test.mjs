...
const checks = [
  ...
  ['dist/index.html', ['/siwei-city/v2/', 'pages-home-hero.webp', 'data-scroll-video', 'hero-scroll-stage', '思维城邦 2.0', '城邦 Wiki', '居民图鉴', '下一屏进入议会机制']],
...
assertIncludes('dist/index.html', '居民图鉴');
