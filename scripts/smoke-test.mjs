...
const checks = [
  ...
  ['dist/index.html', ['/siwei-city/v2/', 'pages-home-hero.webp', 'data-scroll-video', 'hero-scroll-stage', 'data-wiki-tab', '思维城邦 2.0', '城邦 Wiki', '建筑制度', '居民席位', '行动远航']],
...
assertIncludes('dist/index.html', '城邦 Wiki');
assertIncludes('dist/index.html', 'data-wiki-panel="buildings"');
