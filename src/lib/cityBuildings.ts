import type { BuildingActionTarget, BuildingSceneId, ResidentId } from '../types';
...
export interface CityBuilding {
  ...
  primaryActionTarget: BuildingActionTarget;
  emptyTitle: string;
  emptyBody: string;
  exampleItems: string[];
...
export const cityBuildings: CityBuilding[] = [
  ...
  },
  {
    ...
    primaryActionTarget: 'candidates',
  ...
  },
  {
    ...
    primaryActionTarget: 'diagnostics',
